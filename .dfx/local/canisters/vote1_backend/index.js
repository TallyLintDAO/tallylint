...
import { idlFactory } from './vote1_backend.did.js';
export { idlFactory } from './vote1_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.VOTE1_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vote1_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vote1_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vote1_backend.did.js")._SERVICE>}
 */
export const vote1_backend = createActor(canisterId);

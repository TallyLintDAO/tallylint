...
pub async fn save_payload_to_dropbox() -> String {
  ...
  let request_headers = vec![
        ...
        HttpHeader {
            ...
            value: "Bearer sl.BuyKjfKtkY5uYGS0Rpgcsf48_EsXHSldu1jYObvkAPfXzLxaMYBRHTFboyymcWd5cncBsD1sXE5HlnSc0h6lsmtBwSVQXypYPfysA-P9PhfwLKrjUHkuOYlzf2QzGxrv1dUaoimjLYib-btGmCWYdus".to_string(),
        },
